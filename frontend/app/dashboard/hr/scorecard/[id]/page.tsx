        ...
        <div className="p-8 max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-top-4 duration-1000">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2 space-y-6">
                    <Card className="bg-card/45 backdrop-blur-xl border border-border/80 hover-premium-lift rounded-2xl">
                ...
                <div className="space-y-6">
                    ...
                    <Card className="bg-primary/[0.02] backdrop-blur-xl border border-primary/20 rounded-2xl hover-premium-lift">
