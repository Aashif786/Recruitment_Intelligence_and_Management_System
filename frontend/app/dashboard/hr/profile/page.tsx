    ...
    return (
        <div className="p-6 max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <Card className="bg-card/45 backdrop-blur-xl border border-border/80 hover-premium-lift overflow-hidden rounded-2xl">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <Card className="bg-card/45 backdrop-blur-xl border border-border/80 hover-premium-lift overflow-hidden rounded-2xl h-full">
                        <CardHeader className="bg-gradient-to-r from-primary/10 via-primary/5 to-transparent border-b border-border/40">
...
function FeatureBox({ title, description }: any) {
    return (
        <div className="p-5 rounded-2xl bg-muted/30 border border-border/50 hover-premium-lift group cursor-default">
