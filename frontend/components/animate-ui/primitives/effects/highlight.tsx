...
const Highlight = React.forwardRef(function Highlight(
  props: HighlightProps<any>,
  ref: React.Ref<any>
) {
  const {
    as: Component = 'div',
...
const HighlightItem = React.forwardRef(function HighlightItem(
  {
    as,
    children,
    id,
