...
import { getStrictContext } from '@/app/dashboard/lib/get-strict-context';
    ...
    <LocalSidebarProvider value={contextValue}>
      <TooltipProvider openDelay={0}>
        <div
          ...
          className={cn(
            'group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex flex-1 min-h-0 w-full',
            className,
          )}
          {...props}
        >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'fixed top-16 bottom-0 z-10 hidden h-[calc(100svh-4rem)] w-(--sidebar-width) transition-[left,right,width] duration-400 ease-[cubic-bezier(0.75,0,0.25,1)] md:flex',
          side === 'left'
