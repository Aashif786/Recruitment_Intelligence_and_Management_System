...
import { XCircle, Trash2, ListX } from "lucide-react"
...
const STATUS_COLUMNS = [
    ...
    { id: "approved_for_interview", label: "Interview" },
    { id: "hired", label: "Face to Face" },
...
export function PipelineBoard() {
    ...
    const { data: rawApplications = [], error, isLoading, mutate } = useSWR<any[]>('/api/applications', (url: string) => fetcher<any[]>(url))
