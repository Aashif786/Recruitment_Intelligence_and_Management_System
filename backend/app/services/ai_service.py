...
async def parse_resume_with_ai(resume_text: str, job_id: int, job_description: str = "") -> dict:
    ...
    # Set match percentage to 0.0 or calculate based on JD if implemented. For now, 0 or leave AI value
...
async def generate_interview_report(job_title: str, all_qa_pairs: list, overall_score: float, primary_evaluated_skills: list = None) -> dict:
    """
